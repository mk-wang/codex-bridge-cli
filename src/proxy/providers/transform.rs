...
///
/// The extracted Codex translator uses this to decide whether to map
/// `max_output_tokens` to `max_completion_tokens`.
...
/// Inject `stream_options.include_usage` for OpenAI Chat Completions streams.
